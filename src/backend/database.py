...
# Initial announcements example
from datetime import datetime, timedelta

initial_announcements = [
    {
        # store as ISO date strings for portability
        "message": "Welcome back! Fall semester activities begin next week — check the schedule and sign up.",
